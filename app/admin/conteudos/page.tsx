...
// Mapeamento de páginas para nomes amigáveis e ícones
const PAGINAS_CONFIG: Record<string, { nome: string; icone: string }> = {
    home: { nome: "Página Inicial", icone: "home" },
    header: { nome: "Cabeçalho", icone: "web_asset" },
    confirmacao: { nome: "Confirmação", icone: "check_circle" },
    footer: { nome: "Rodapé", icone: "bottom_navigation" },
};

type TabType = "textos" | "cadastros";
