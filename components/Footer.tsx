            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex items-center gap-4">
                        <a
                            href="https://www.instagram.com/wagnerchavesadvogados/"
                            target="_blank"
                            rel="noopener noreferrer"
                        ...
                        <a
                            href="https://www.linkedin.com/company/wagner-chaves/"
                            target="_blank"
                            rel="noopener noreferrer"
                        ...
                        <a
                            href="https://www.facebook.com/people/Escrit%C3%B3rio-Wagner-Chaves-Advogados-Associados/61550093044280/"
                            target="_blank"
                            rel="noopener noreferrer"
